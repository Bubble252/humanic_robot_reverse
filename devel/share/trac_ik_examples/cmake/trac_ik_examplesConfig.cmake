...
if("TRUE" STREQUAL "TRUE")
  set(trac_ik_examples_SOURCE_PREFIX /root/arm/reverse_ws/src/trac_ik/trac_ik_examples)
  set(trac_ik_examples_DEVEL_PREFIX /root/arm/reverse_ws/devel)
  ...
  set(trac_ik_examples_INSTALL_PREFIX /root/arm/reverse_ws/install)
...
if(NOT "/usr/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/arm/reverse_ws/src/trac_ik/trac_ik_examples/${idir}'.  ${_report}")
    endif()
